...
<div class="container">
  ...
  <div class="collapse navbar-collapse" id="myNavbarbottom">
      <ul class="nav navbar-nav">
         ...
         <li><a href="http://localhost:8084/Priyakart/mvc/sells" target='_new'>SELLER HUB</a></li>
         <li><a href="http://localhost:8084/Priyakart/mvc/priyakart" target='_new'>PRIYAKART.COM </a></li>
      </ul>
   </div>
  </div>	